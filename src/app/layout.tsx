...
export const metadata: Metadata = {
    title: "Manish Kumar | MERN Stack Developer",
    description:
        "Manish Kumar is a proficient Software Engineer and Full Stack Developer from India, skilled in front-end and back-end development using modern tech stacks.",
    robots: {
        index: true,
        follow: true,
        googleBot: {
